...
public class RaidPartyPanel extends PluginPanel {
    ...
    private final JLabel emptyStateLabel = new JLabel("<html><center>Not in a party.<br><font color='#777777'>Create/Join a party to begin.</font></center></html>");
    ...
    public RaidPartyPanel(RaidPartyPlugin plugin) {
        ...
        joinNewButton.addActionListener(e -> {
            ...
            if(p != null && !p.trim().isEmpty()) plugin.joinParty(p.trim());
        });
        
        topRowButtons.add(createButton);
        topRowButtons.add(joinNewButton);
        
        JButton joinPreviousButton = new FlatButton("Join previous party", new Color(35, 35, 35), new Color(45, 45, 45));
        ...
        copyButton.addActionListener(e -> {
            ...
            copyButton.setText("");
            javax.swing.Timer timer = new javax.swing.Timer(1500, evt -> { copyButton.setIcon(copyIcon); copyButton.setText(""); });
        ...
        readyBtn.addActionListener(e -> {
            plugin.setReadyState(1);
            readyBtn.setEnabled(false);
            notReadyBtn.setEnabled(true);
        });

        notReadyBtn.addActionListener(e -> {
            plugin.setReadyState(2);
            notReadyBtn.setEnabled(false);
    ...
    public void addMember(String username, boolean isLocal) {
        SwingUtilities.invokeLater(() -> {
            ...
            if (memberCards.containsKey(sanitized)) return;
    ...
    public void onPlayerSync(RaidPartyPlayerSync sync) {
        if (sync == null || sync.getUsername() == null) return;
        SwingUtilities.invokeLater(() -> {
    ...
    public static class FlatButton extends JButton {
        ...
        protected void paintComponent(Graphics g) {
            ...
            if (isHovered) borderColor = borderColor.brighter();
