...
public class RaidPartyPlayerSync extends PartyMemberMessage {
    ...
    // Active prayer IDs (ordinals of Prayer enum)
    private int[] activePrayerIds;
    ...
    // Prayer states (ordinals)
    private int[] availablePrayerIds; // Prayers player has the level for
    private int[] unlockedPrayerIds;  // Prayers unlocked via quests/rewards
